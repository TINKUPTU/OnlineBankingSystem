...
<a class="navbar-brand" href="/forum"><img src="img/logo.png"  alt="..." width="40"></a>
...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
  <ul class="navbar-nav mr-auto">
    ...
    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
      <a class="dropdown-item" href="all_cust.php">View All Customers</a>
      <a class="dropdown-item" href="send_money.php">Send Money</a>
      <a class="dropdown-item" href="transactions.php">See Transactions History</a>
    </div>
  </div>
 ...
 if(isset($_GET['signupsuccess']) && $_GET['signupsuccess']=="true"){
   ...
   <strong>SignUp Success!</strong> You can now login
